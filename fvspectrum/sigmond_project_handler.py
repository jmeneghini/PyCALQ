...
def parse_data_files(data_list):
    ...
    return (
        list(data_files.bl_corr_files)
        + list(data_files.bl_vev_files)
        + list(data_files.bin_files)
        + list(data_files.sampling_files)
    )
...
class SigmondProjectHandler:
    ...
    def add_raw_data(self, raw_data_files):
        self.add_data(
            raw_data_files,
            self.data_handler.raw_data_files,
            self.clear_raw_data,
            self.data_handler.rel_raw_datadir,
            self.data_handler._findRawData,
            self.data_handler._raw_data,
        )
    ...
    def add_averaged_data(self, data_files):
        self.add_data(
            ...
            self.data_handler.rel_averaged_datadir,
            self.data_handler.findAveragedData,
            self.data_handler._averaged_data,
        )
    ...
    def add_rotated_data(self, data_files):
        self.add_data(
            data_files,
            self.data_handler.rotated_data_files,
            self.clear_rotated_data,
            self.data_handler.rel_rotated_datadir,
            self.data_handler.findRotatedData,
            self.data_handler._rotated_data,
        )
