...
def setup_parser():
    ...
    convert_parser = subparsers.add_parser(
        "estimates-to-fit-cfg", help="Convert estimates CSV to fit configuration YAML"
    )
...
def set_multiprocessing_start_method():
    ...
    if required_method in mp.get_all_start_methods():
        ...
        raise RuntimeError(
            f"Required multiprocessing start method '{required_method}' is not available on this platform."
        )
